...
function Form() {
    ...
    return (
        <>
            {
                content ? <div className='d-flex justify-content-center bg-light p-5 flex-column text-center'>
                    <p className='p-3'>구독신청해주셔서 감사합니다.</p>
                    <GreenBtn className='mx-auto' onClick={() => {
                        setContent(false)
                    }}>구독신청 다시하기</GreenBtn>
                </div> :
