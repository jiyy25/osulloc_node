...
function BestCategory() {
    ...
    return (
        <div className='BestCategory container mb-100'>
            ...
            <SmallTitle className='smT'>다채로운 차 향기로 더욱 풍요로워지는 <br className='d-sm-none'/> 티 라이프를 만나보세요.</SmallTitle>
