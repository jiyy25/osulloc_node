...
function Footer() {
    return (
        <footer className='d-lg-flex bg-dark pt-5 pb-4 justify-content-between align-items-start px-5'>
            <div className='f_logo d-none d-lg-block'>
                <Link to='/'></Link>
            ...
            <div className='leftDesc order-lg-1'>
                ...
                <div>
                    <span>㈜ 오설록</span>
                    <p>대표이사:서혁제 주소:서울특별시 용산구 한강대로 100 (한강로2가) 사업자등록번호: 390-87-01499</p>
